...
type
  TfrmGame = class(TForm)
    ...
    procedure Label14DragOver(Sender, Source: TObject; X, Y: Integer;
      State: TDragState; var Accept: Boolean);
    procedure Button4Click(Sender: TObject);
    procedure Button5Click(Sender: TObject);
    procedure Label13DragOver(Sender, Source: TObject; X, Y: Integer;
      State: TDragState; var Accept: Boolean);
    procedure Label15DragOver(Sender, Source: TObject; X, Y: Integer;
      State: TDragState; var Accept: Boolean); var
...
procedure TfrmGame.Label14DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Label14.Top := Label14.Top - Label14.Height div 2 + Y;
  Label14.Left := Label14.Left - Label14.Width div 2 + X;
end;



procedure TfrmGame.Label15DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
      Label15.Top := Label15.Top - Label15.Height div 2 + Y;
      Label15.Left := Label15.Left - Label15.Width div 2 + X;
end;
